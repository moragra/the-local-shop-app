  ...
  return (
    ...
    <main>
      ...
      <section>
        ...
        <p>
          Local businesses aren't just places to shop—they're the heartbeat of our neighborhoods, the backbone of our communities. By choosing to support local, you're not only investing in the economic vitality of your community but also preserving its culture, character, and sense of belonging for generations to come.
        </p>
      </section>
      <section>
        <h2>A Global Perspective</h2>
        <p>
          We recognize that the challenges facing local businesses extend far beyond our own neighborhoods. From the shores of Costa Rica to the streets of Palestine, communities worldwide are grappling with the impacts of gentrification and economic displacement. By amplifying the voices of local businesses and providing a platform for their visibility, we're committed to addressing these global challenges and creating positive change, one community at a time.
        </p>
      </section>
      <section>
        <h2>Join Us</h2>
